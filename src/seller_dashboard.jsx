...
<DashboardLeft/>
      <div className="sidebar_mid">
        <div className="sidebar_mid_navbar">
          <h3>Dashboard</h3>
          <input type="search" placeholder="Search your product" />
        
        </div>
        <div className="sidebar_mid_content">
          <div className="sidebar_mid_cards">
            <div className="sidebar_mid_card" style={{  background:"wheat"}}>
            ...
            <div className="sidebar_mid_card" style={{  background:"violet"}}>
            ...
            <div className="sidebar_mid_card" style={{background:"palegreen"}}>
